...
impl<T: RequestHandler> ServerFuture<T> {
    ...
    pub fn register_tls_listener(
        ...
        use hickory_proto::openssl::{tls_server, TlsStream};
        use openssl::ssl::Ssl;
        use std::pin::Pin;
    ...
    pub fn register_tls_listener_with_tls_config(
        ...
        use hickory_proto::rustls::tls_from_stream;
    ...
    pub fn register_quic_listener(
        ...
        use hickory_proto::quic::QuicServer;
    ...
    pub fn register_h3_listener(
        ...
        use hickory_proto::h3::h3_server::H3Server;
